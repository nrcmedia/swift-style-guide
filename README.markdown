...
This style guide is used for all projects of NRC Media. As you can see it is a forked from [The Official raywenderlich.com Swift Style Guide](The Official raywenderlich.com Swift Style Guide), but now is its own document additions and changes. See the git log for specific changes.
